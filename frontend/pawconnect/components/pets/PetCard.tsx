...
export function PetCard({ pet }: { pet: Pet }) {
  ...
  return (
    <Link href={`/pets/${pet.id}`}>
      <Card className="group cursor-pointer hover:shadow-xl transition-all duration-300 hover:-translate-y-1 h-full flex flex-col border-transparent hover:border-orange-200 dark:hover:border-orange-900/50">
