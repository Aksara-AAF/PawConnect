...
export default function Home() {
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-slate-50">
      ...
      <main className="flex-1 overflow-y-auto snap-y snap-mandatory relative scroll-smooth">

        {/* SNAP 1: HERO SECTION */}
        <section className="snap-start snap-always shrink-0 relative flex flex-col justify-center w-full h-full overflow-hidden bg-teal-50">
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="flex flex-col items-center gap-12 py-12 lg:flex-row">
              <div className="flex-1 z-10 text-center lg:text-left">
                <div className="inline-flex items-center px-4 py-2 mb-6 text-sm font-semibold rounded-full text-teal-800 bg-teal-100/80">
          ...
          <div className="absolute top-0 right-0 -mr-20 -mt-20 w-[500px] h-[500px] bg-teal-200 rounded-full blur-3xl opacity-30 pointer-events-none"></div>
          <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-[400px] h-[400px] bg-orange-100 rounded-full blur-3xl opacity-40 pointer-events-none"></div>
        </section>
        ...
        <section className="snap-start snap-always shrink-0 relative flex flex-col justify-center w-full h-full bg-teal-900 pb-16">
          ...
          <div className="relative z-10 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4 sm:gap-6">
              <Link href="/pets?species=Anjing" className="flex flex-col items-center justify-center p-6 transition-all bg-white shadow-lg sm:p-8 rounded-2xl hover:shadow-2xl hover:-translate-y-2 group border border-teal-50">
              ...
              <Link href="/pets?species=Kucing" className="flex flex-col items-center justify-center p-6 transition-all bg-white shadow-lg sm:p-8 rounded-2xl hover:shadow-2xl hover:-translate-y-2 group border border-teal-50">
                <div className="p-4 transition-colors rounded-full bg-teal-50 text-teal-700 group-hover:bg-orange-100 group-hover:text-orange-600">
              ...
              <Link href="/pets?species=Lainnya" className="flex flex-col items-center justify-center p-6 transition-all bg-white shadow-lg sm:p-8 rounded-2xl hover:shadow-2xl hover:-translate-y-2 group border border-teal-50">
                <div className="p-4 transition-colors rounded-full bg-teal-50 text-teal-700 group-hover:bg-orange-100 group-hover:text-orange-600">
              ...
              <Link href="/donate" className="flex flex-col items-center justify-center p-6 transition-all bg-white shadow-lg sm:p-8 rounded-2xl hover:shadow-2xl hover:-translate-y-2 group border border-teal-50">
                <div className="p-4 transition-colors rounded-full bg-teal-50 text-teal-700 group-hover:bg-orange-100 group-hover:text-orange-600">
                ...
                <span className="mt-4 font-bold text-center text-teal-950 sm:text-lg">Shelter & Rescue</span>
              </Link>
            </div>
          </div>
        </section>

        {/* SNAP 3: PREVIEW KATALOG */}
        ...
        <section className="snap-start snap-always shrink-0 relative flex flex-col justify-center w-full h-full bg-white">
          <div className="px-6 py-10 sm:px-12 lg:px-24 max-w-6xl mx-auto w-full">
            <div className="mb-12 text-center">
              ...
              <p className="mt-4 text-lg text-teal-700/70">Membawa kebahagiaan untuk hewan dan manusia melalui sistem yang transparan.</p>
            </div>
            <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
              <div className="p-8 transition-all duration-300 bg-slate-50 rounded-3xl hover:shadow-xl hover:-translate-y-2 hover:bg-teal-50/50">
                ...
                <p className="mt-3 text-teal-800/70">Hubungi pengunggah hewan secara langsung untuk proses adopsi yang lebih personal dan cepat.</p>
              </div>
              <div className="p-8 transition-all duration-300 bg-slate-50 rounded-3xl hover:shadow-xl hover:-translate-y-2 hover:bg-teal-50/50">
                ...
                <p className="mt-3 text-teal-800/70">Bantu shelter dengan donasi yang tercatat rapi. Setiap rupiah sangat berarti bagi mereka.</p>
              </div>
              <div className="p-8 transition-all duration-300 bg-slate-50 rounded-3xl hover:shadow-xl hover:-translate-y-2 hover:bg-teal-50/50">
                ...
                <p className="mt-3 text-teal-800/70">Identitas dan data pengguna terlindungi untuk menciptakan komunitas penyayang hewan yang aman.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* FOOTER MANUAL UNTUK LANDING PAGE */}
